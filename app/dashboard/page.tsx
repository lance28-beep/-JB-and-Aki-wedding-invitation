...
export default function DashboardPage() {
    ...
    return (
      <div className="min-h-screen bg-[#F9F8F4] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-lg border border-[#688277]/20">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-[#688277]/10 rounded-full mb-4">
              ...
              <p className="text-[#0A3629]/60 font-sans text-sm">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-[#0A3629] mb-2 font-sans">
                  Password
                </label>
                <input
                  type="password"
                  ...
                  className="w-full px-4 py-3 border border-[#688277]/20 focus:border-[#0A3629] rounded-xl font-sans placeholder:text-[#0A3629]/40 transition-all duration-300 focus:ring-2 focus:ring-[#0A3629]/10 bg-white"
                  autoFocus
                />
              </div>

              {error && (
                <div className="bg-[#688277]/10 border border-[#0A3629]/30 rounded-xl p-3 flex items-center gap-2">
                  <AlertCircle className="h-5 w-5 text-[#0A3629]" />
                  <span className="text-[#0A3629] font-semibold text-sm">{error}</span>
                </div>
              )}

              <Button
                type="submit"
                className="w-full bg-[#0A3629] hover:bg-[#0A3629]/90 text-[#F9F8F4] py-3 rounded-xl font-semibold transition-all duration-300"
              >
                Access Dashboard
              </Button>
            </form>
  ...
  return (
    <div className="min-h-screen bg-[#F9F8F4]">
      {/* Header */}
      <div className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-[#688277]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-[family-name:var(--font-crimson)] font-bold text-[#0A3629]">Wedding Dashboard</h1>
              <p className="text-[#0A3629]/60 text-sm font-sans">Manage your guest list and RSVPs</p>
            </div>
            <div className="flex items-center gap-3">
              <Button
                ...
                variant="outline"
                size="sm"
                className="border-[#688277]/20 text-[#0A3629] hover:bg-[#688277]/10"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#688277]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <Users className="h-6 w-6 sm:h-8 sm:w-8 text-[#0A3629]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#0A3629]">{stats.totalGuests}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#0A3629]/70 font-sans">Total Guests</p>
            <p className="text-xs text-[#0A3629]/50 font-sans mt-1">{stats.total} entries</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#126555]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <CheckCircle className="h-6 w-6 sm:h-8 sm:w-8 text-[#126555]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#126555]">{stats.attending}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#0A3629]/70 font-sans">Attending</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#0A3629]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <XCircle className="h-6 w-6 sm:h-8 sm:w-8 text-[#0A3629]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#0A3629]">{stats.notAttending}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#0A3629]/70 font-sans">Not Attending</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#9F8650]/30 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <AlertCircle className="h-6 w-6 sm:h-8 sm:w-8 text-[#9F8650]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#9F8650]">{stats.pending}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#0A3629]/70 font-sans">Pending</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#9F8650]/30 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <Bell className="h-6 w-6 sm:h-8 sm:w-8 text-[#9F8650]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#9F8650]">{guestRequests.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#0A3629]/70 font-sans">Requests</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#126555]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <Crown className="h-6 w-6 sm:h-8 sm:w-8 text-[#126555]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#126555]">{entourage.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#0A3629]/70 font-sans">Entourage</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#688277]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <UserPlus className="h-6 w-6 sm:h-8 sm:w-8 text-[#0A3629]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#0A3629]">{principalSponsors.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#0A3629]/70 font-sans">Principal Sponsors</p>
          </div>
        </div>

        {/* Tabs */}
        <div className="bg-white/90 rounded-2xl p-1 sm:p-2 shadow-sm border border-[#688277]/20 mb-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-2">
            <button
              onClick={() => setActiveTab("guests")}
              className={`w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm font-[family-name:var(--font-crimson)] font-semibold transition-all duration-300 flex items-center justify-center gap-1.5 sm:gap-2 ${
                activeTab === "guests"
                  ? "bg-[#0A3629] text-[#F9F8F4] shadow-md"
                  : "text-[#0A3629] hover:bg-[#688277]/10"
              }`}
            >
            ...
            <button
              ...
              className={`w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm font-[family-name:var(--font-crimson)] font-semibold transition-all duration-300 flex items-center justify-center gap-1.5 sm:gap-2 relative ${
                activeTab === "requests"
                  ? "bg-[#0A3629] text-[#F9F8F4] shadow-md"
                  : "text-[#0A3629] hover:bg-[#688277]/10"
              }`}
            >
              ...
              {guestRequests.length > 0 && (
                <span className="absolute -top-1 -right-1 bg-[#9F8650] text-[#F9F8F4] text-[10px] sm:text-xs font-bold rounded-full min-w-[18px] h-4 sm:min-w-[20px] sm:h-5 px-1 flex items-center justify-center">
        ...
        <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#688277]/20 mb-6">
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-4">
            <div className="flex-1 w-full">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-[#0A3629]/40" />
                <input
                  type="text"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  placeholder="Search guests by name or email..."
                  className="w-full pl-10 pr-4 py-2 border border-[#0A3629]/20 focus:border-[#0A3629] rounded-xl font-sans placeholder:text-[#0A3629]/40 transition-all duration-300 focus:ring-2 focus:ring-[#0A3629]/10 bg-white"
                />
              </div>
            </div>
            <Button
              ...
              className="bg-[#0A3629] hover:bg-[#0A3629]/90 text-[#F9F8F4] transition-all duration-300"
            >
          ...
          {successMessage && (
            <div className="bg-[#126555]/10 border border-[#126555]/30 rounded-xl p-3 mb-4 flex items-center gap-2">
              <CheckCircle className="h-5 w-5 text-[#126555]" />
              <span className="text-[#126555] font-semibold text-sm">{successMessage}</span>
            </div>
          )}

          {error && (
            <div className="bg-[#688277]/10 border border-[#0A3629]/30 rounded-xl p-3 mb-4 flex items-center gap-2">
              <AlertCircle className="h-5 w-5 text-[#0A3629]" />
              <span className="text-[#0A3629] font-semibold text-sm">{error}</span>
            </div>
          )}
        ...
        {/* Guest List */}
        <div className="bg-white/90 rounded-2xl shadow-sm border border-[#688277]/20 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-[#688277]/10">
                <tr>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Name</th>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Email</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">RSVP</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)] whitespace-nowrap">
                    <span className="flex items-center justify-center gap-1">
                      <Users className="h-4 w-4" />
                      Guests
                    </span>
                  </th>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Message</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#688277]/20">
                {filteredGuests.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-[#0A3629]/60 font-sans">
                      {isLoading ? (
                        <div className="flex items-center justify-center gap-2">
                          <RefreshCw className="h-5 w-5 animate-spin text-[#0A3629]" />
                  ...
                  filteredGuests.map((guest, index) => (
                    <tr key={index} className="hover:bg-[#688277]/10 transition-colors">
                      <td className="px-6 py-4 font-medium text-[#0A3629] font-sans">{guest.Name}</td>
                      <td className="px-6 py-4 text-[#0A3629]/70 font-sans">
                        {guest.Email && guest.Email !== "Pending" ? guest.Email : "-"}
                      </td>
                      <td className="px-6 py-4 text-center">
                        {guest.RSVP === "Yes" && (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#126555]/20 text-[#126555] rounded-full text-sm font-semibold">
                            <CheckCircle className="h-4 w-4" />
                            Attending
                          </span>
                        )}
                        {guest.RSVP === "No" && (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#0A3629]/20 text-[#0A3629] rounded-full text-sm font-semibold">
                            <XCircle className="h-4 w-4" />
                            Not Attending
                          </span>
                        )}
                        {guest.RSVP === "Maybe" && (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#9F8650]/20 text-[#9F8650] rounded-full text-sm font-semibold">
                            <AlertCircle className="h-4 w-4" />
                            Maybe
                          </span>
                        )}
                        {!guest.RSVP || guest.RSVP.trim() === "" ? (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#688277]/10 text-[#0A3629]/70 rounded-full text-sm font-semibold">
                            Pending
                          </span>
                        ) : null}
                      </td>
                      <td className="px-6 py-4 text-center">
                        <span className="inline-flex items-center justify-center px-3 py-1.5 bg-[#126555]/20 text-[#126555] rounded-full text-sm font-bold min-w-[3.5rem] border border-[#126555]/30">
                          {guest?.Guest !== undefined && guest?.Guest !== null && guest?.Guest !== '' 
                            ? (parseInt(String(guest.Guest)) || 1) 
                            : 1}
                        </span>
                      </td>
                      <td className="px-6 py-4 text-[#0A3629]/70 font-sans max-w-xs truncate" title={guest.Message || ""}>
                        {guest.Message || "-"}
                      </td>
                      <td className="px-6 py-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="p-2 text-[#0A3629] hover:bg-[#688277]/10 rounded-lg transition-colors"
                            title="Edit guest"
                          >
                ...
                <table className="w-full">
                  <thead className="bg-[#688277]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Name</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Email</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Phone</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)] whitespace-nowrap">
                        <span className="flex items-center justify-center gap-1">
                          <Users className="h-4 w-4" />
                          Guests
                  ...
                  <tbody className="divide-y divide-[#688277]/20">
                    {filteredRequests.length === 0 ? (
                      ...
                      filteredRequests.map((request, index) => (
                        <tr key={index} className="hover:bg-[#688277]/10 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#0A3629] font-sans">{request.Name}</td>
                          <td className="px-6 py-4 text-[#0A3629]/70 font-sans">
                          ...
                          <td className="px-6 py-4 text-[#0A3629]/70 font-sans max-w-xs truncate">
                            {request.Message || "-"}
                          </td>
                          <td className="px-6 py-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              <button
                                ...
                                className="px-4 py-2 bg-[#0A3629] hover:bg-[#0A3629]/90 text-[#F9F8F4] rounded-lg transition-colors font-semibold text-sm flex items-center gap-2 shadow-sm hover:shadow-md"
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#688277]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Name</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Role Category</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Role Title</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Email</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#688277]/20">
                    {filteredEntourage.length === 0 ? (
                      <tr>
                        <td colSpan={5} className="px-6 py-12 text-center text-[#0A3629]/60 font-sans">
                          {isLoading ? (
                            <div className="flex items-center justify-center gap-2">
                              <RefreshCw className="h-5 w-5 animate-spin text-[#0A3629]" />
                      ...
                      filteredEntourage.map((member, index) => (
                        <tr key={index} className="hover:bg-[#688277]/10 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#0A3629] font-sans">{member.Name}</td>
                          <td className="px-6 py-4 text-[#0A3629]/70 font-sans">
                            {member.RoleCategory || "-"}
                          </td>
                          <td className="px-6 py-4 text-[#0A3629]/70 font-sans">
            ...
            <div className="bg-white/90 rounded-2xl shadow-sm border border-[#688277]/20 overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#688277]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Male Principal Sponsor</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Female Principal Sponsor</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#688277]/20">
                    {filteredPrincipalSponsors.length === 0 ? (
                      <tr>
                        <td colSpan={3} className="px-6 py-12 text-center text-[#0A3629]/60 font-sans">
                          {isLoading ? (
                            <div className="flex items-center justify-center gap-2">
                              <RefreshCw className="h-5 w-5 animate-spin text-[#0A3629]" />
                      ...
                      filteredPrincipalSponsors.map((sponsor, index) => (
                        <tr key={index} className="hover:bg-[#688277]/10 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#0A3629] font-sans">{sponsor.MalePrincipalSponsor}</td>
                          <td className="px-6 py-4 text-[#0A3629]/70 font-sans">
...
function AddToGuestListModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-[#688277]/20">
        <div className="sticky top-0 bg-[#688277]/10 px-6 py-4 border-b border-[#688277]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Add to Guest List</h3>
            <button
              onClick={onCancel}
              className="p-2 hover:bg-[#688277]/10 rounded-lg transition-colors text-[#0A3629]/70 hover:text-[#0A3629]"
            >
        ...
        <div className="p-6">
          <div className="mb-6">
            <p className="text-base text-[#0A3629] font-sans leading-relaxed">
              <span className="font-bold text-lg">{request.Name}</span> is requesting to join your wedding with a total of{' '}
              <span className="font-bold text-lg text-[#126555]">{guestCount}</span>{' '}
              {guestCount === 1 ? 'guest' : 'guests'}.
            </p>
          </div>
          
          <div className="bg-[#126555]/5 rounded-xl p-4 mb-6 border border-[#126555]/20">
            <p className="text-sm font-semibold text-[#0A3629] mb-2 font-sans">Request Details:</p>
            <div className="space-y-2 text-sm text-[#0A3629]/80 font-sans">
              ...
              {request.Message && (
                <div className="mt-2 pt-2 border-t border-[#126555]/20">
          ...
          <p className="text-sm text-[#0A3629]/70 mb-6 font-sans">
          ...
          <div className="flex gap-3">
            <Button
              onClick={onConfirm}
              disabled={isLoading}
              className="flex-1 bg-[#0A3629] hover:bg-[#0A3629]/90 text-[#F9F8F4] disabled:opacity-50"
            >
              {isLoading ? (
                <>
            ...
            <Button onClick={onCancel} variant="outline" className="px-6 border-[#0A3629]/20" disabled={isLoading}>
              Cancel
            </Button>
          </div>
        </div>
...
function EntourageModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl border border-[#688277]/20 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#688277]/10 px-6 py-4 border-b border-[#688277]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">{editing ? 'Edit Entourage Member' : 'Add New Entourage Member'}</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#688277]/10 rounded-lg transition-colors text-[#0A3629]/70 hover:text-[#0A3629]"
            >
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-[#0A3629] mb-2 font-sans">Name *</label>
              <input
                type="text"
                value={formData.Name}
                onChange={(e) => setFormData({ ...formData, Name: e.target.value })}
                className="w-full px-4 py-2 border border-[#0A3629]/20 focus:border-[#0A3629] rounded-xl text-sm font-sans placeholder:text-[#0A3629]/40 transition-all duration-300 focus:ring-2 focus:ring-[#0A3629]/10 bg-white"
                required
              />
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm font-medium text-[#0A3629] mb-2 font-sans">Email</label>
              <input
                type="email"
          ...
          <div className="flex gap-3 mt-6">
            <Button
              onClick={onSave}
              disabled={isLoading}
              className="flex-1 bg-[#0A3629] hover:bg-[#0A3629]/90 text-[#F9F8F4]"
            >
              {isLoading ? (
                <>
                  <RefreshCw className="h-4 w-4 mr-2 animate-spin" />
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#0A3629]/20">Cancel</Button>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl border border-[#688277]/20 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#688277]/10 px-6 py-4 border-b border-[#688277]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 mt-6">
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#0A3629]/20" disabled={isLoading}>
              Cancel
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-[#688277]/20">
        <div className="sticky top-0 bg-[#688277]/10 px-6 py-4 border-b border-[#688277]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Add New Guest</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#688277]/10 rounded-lg transition-colors text-[#0A3629]/70 hover:text-[#0A3629]"
            >
        ...
        <div className="p-6">
          <p className="text-sm text-[#0A3629]/70 mb-4 font-sans leading-relaxed">
          ...
          <div>
            ...
            <input
              ...
              value={formData.Name}
              onChange={(e) => setFormData({ ...formData, Name: e.target.value })}
              className="w-full px-4 py-3 border border-[#0A3629]/20 focus:border-[#0A3629] rounded-xl text-sm font-sans placeholder:text-[#0A3629]/40 transition-all duration-300 focus:ring-2 focus:ring-[#0A3629]/10 bg-white"
          ...
          <div className="flex gap-3 mt-6">
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#0A3629]/20">
              Cancel
            </Button>
          </div>
        </div>
...
function EditGuestModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-[#688277]/20 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#688277]/10 px-6 py-4 border-b border-[#688277]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">Edit Guest</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#688277]/10 rounded-lg transition-colors text-[#0A3629]/70 hover:text-[#0A3629]"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-[#0A3629]/20 focus:border-[#0A3629] rounded-xl text-sm font-sans bg-white transition-all duration-300 focus:ring-2 focus:ring-[#0A3629]/10"
                required
              >
...
function ConfirmModal({ open, title, message, onCancel, onConfirm }: { open: boolean; title: string; message: string; onCancel: () => void; onConfirm: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl border border-[#688277]/20">
        <div className="px-5 py-4 border-b border-[#688277]/20 bg-[#688277]/10 rounded-t-2xl">
          <h3 className="text-base sm:text-lg font-bold text-[#0A3629] font-[family-name:var(--font-crimson)]">{title}</h3>
        </div>
        <div className="px-5 py-4 text-sm sm:text-base text-[#0A3629]/80 font-sans">
          {message}
        </div>
        <div className="px-5 py-4 flex justify-end gap-2 border-t border-[#688277]/20">
          <button onClick={onCancel} className="px-4 py-2 text-sm rounded-lg border border-[#0A3629]/20 text-[#0A3629] hover:bg-[#688277]/10 transition-colors font-sans">Cancel</button>
          <button onClick={onConfirm} className="px-4 py-2 text-sm rounded-lg bg-[#0A3629] text-[#F9F8F4] hover:bg-[#0A3629]/90 transition-colors font-sans">Delete</button>
        </div>
      </div>
    </div>
  )
